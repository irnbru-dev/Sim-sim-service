...
function project_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'project_custom_background_args', array(
...
function project_scripts() {
	...
	wp_enqueue_script( 'project-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
